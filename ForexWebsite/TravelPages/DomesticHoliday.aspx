<%@ Page Title="" Language="C#" MasterPageFile="~/TravelPages/TravelMaster.master" AutoEventWireup="true" CodeFile="DomesticHoliday.aspx.cs" Inherits="TravelPages_DomesticHoliday" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
    <br />
                 <%--    Domestic places for honeymoon--%>
		<div id="Div4" class="fh5co-section-gray">
			<div class="container">
				<div class="row">
					<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
						<h3>Our Blog</h3>
									 ...
									 <div role="tabpanel" class="tab-pane active" id="flights">
										<div class="row">
											...
											<%--	<input type="submit" class="btn btn-primary btn-block" value="Search Flight">--%>
                                                <asp:Button ID="btnSubmit" runat="server" Text="Send Details"  class="btn btn-primary btn-block" OnClick="btnSubmit_Click" />
											</div>
